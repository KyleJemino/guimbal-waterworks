defmodule GuimbalWaterworksWeb.UsersSettingsControllerTest do
  ...
  describe "PUT /users/settings (change password form)" do
    test "updates the users password and resets tokens", %{conn: conn, users: users} do
      new_password_conn =
        put(conn, Routes.users_settings_path(conn, :update), %{
      ...
      assert redirected_to(new_password_conn) == Routes.users_settings_path(conn, :edit)
  ...
  describe "PUT /users/settings (change email form)" do
    ...
    test "updates the users email", %{conn: conn, users: users} do
      ...
      assert redirected_to(conn) == Routes.users_settings_path(conn, :edit)
