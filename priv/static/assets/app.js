...
`, template.innerHTML.trim());
  ...
  // js/hooks/generateDisconnectionCsv.js
  var generateDisconnectionCsv_default = {
    mounted() {
  ...
  var Hooks2 = {
    ...
    GenerateDisconnectionCSV: generateDisconnectionCsv_default
  };
